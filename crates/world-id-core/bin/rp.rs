...
const DEFAULT_KEY_GEN_CONTRACT_ADDRESS: Address = address!("0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9");
...
async fn main() -> Result<()> {
    ...
    let current_time_stamp = SystemTime::now()
        ...
        .expect("system time is after unix epoch").as_secs() as u64;
