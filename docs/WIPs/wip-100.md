...
description: Establishes the default cryptograhic primitives used throughout the Protocol.
...
This spec establishes the default cryptograhic primitives used throughout the World ID Protocol (the "Protocol") such as the default elliptic curve, field, signature scheme and hashing. It includes particularly important constraints and validations which are security-critical. 
...
### Poseidon2 in compression mode

For a security argument of using Poseidon2 with state size 2 as a 2-1 compression mode, we refer to both section 3.1 of the [Poseidon2 paper](https://eprint.iacr.org/2023/323.pdf) as well as the treatment of the construction in section 4.2 of the [Griffin paper](https://eprint.iacr.org/2022/403.pdf).
