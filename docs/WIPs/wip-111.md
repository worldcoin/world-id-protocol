...
Defined in [WIP-110 Token claims](wip-110.md#341-token-claims). The circuit reads `iat`, `credential_commitment`, `live_commitment`, `challenge_commitment`, `similarity_live` and `similarity_challenge`. All are private.
