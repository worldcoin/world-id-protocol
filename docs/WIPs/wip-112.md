...
### 3.5 Completion and Reconnection
...
This WIP defines a transport profile for WIP-109. It does not change the registration protocol, contracts or stored data, and implementations may continue to carry WIP-109 over other transports. Devices that do not support iroh are unaffected.
