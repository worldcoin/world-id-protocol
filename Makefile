...
sol-build:
	...
	mkdir -p ../crates/registry/abi ../crates/issuer/abi ../services/oprf-node/abi && \
	forge inspect WorldIDRegistry abi --json > ../crates/registry/abi/WorldIDRegistryAbi.json && \
