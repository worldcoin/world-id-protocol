...
contract InsertAuthenticatorScript is Script {
    ...
    function run() public {
        ...
        authenticatorAddresses[0] = address(
            uint160(0x001a642f0e3c3af545e7acbd38b07251b3990914f1)
        );
        uint256[] memory authenticatorPubkeys = new uint256[](1);
        authenticatorPubkeys[
            0
        ] = 57915933778004089767388106625639599040044329507355901050367950978468818626307;
