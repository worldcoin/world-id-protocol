...
} from "../../test/crosschain/helpers/Mocks.sol";
...
contract DeployE2E is Script {
    function run() public {
        ...
        vm.writeJson(out, "test/crosschain/fixtures/e2e_mpt/wc_addrs.json");
...
contract PropagateE2E is Script {
    function run() public {
        ...
        string memory wcAddrs = vm.readFile("test/crosschain/fixtures/e2e_mpt/wc_addrs.json");
...
contract DeployAndRelayE2E is Script {
    ...
    function run() public {
        string memory wcAddrs = vm.readFile("test/crosschain/fixtures/e2e_mpt/wc_addrs.json");
        string memory round1Json = vm.readFile("test/crosschain/fixtures/e2e_mpt/round1.json");
        string memory round2Json = vm.readFile("test/crosschain/fixtures/e2e_mpt/round2.json");
        string memory proofJson = vm.readFile("test/crosschain/fixtures/e2e_mpt/proof.json");
        ...
        vm.writeJson(out, "test/crosschain/fixtures/e2e_mpt/eth_addrs.json");
...
contract VerifyE2E is Script {
    function run() public view {
        ...
        string memory ethAddrs = vm.readFile("test/crosschain/fixtures/e2e_mpt/eth_addrs.json");
