    ...
    insert_test_world_tree_event(
        ...
        &BlockchainEvent {
            ...
            details: RegistryEvent::AccountCreated(AccountCreatedEvent {
                ...
                authenticatorAddresses: vec![],
                authenticatorPubkeys: vec![],
                offchainSignerCommitment: U256::from(200),
            }),
        },
    )
    .await
    ...
    insert_test_world_tree_event(
        ...
        &BlockchainEvent {
            ...
            details: RegistryEvent::AccountUpdated(AccountUpdatedEvent {
                leafIndex: 1,
                pubkeyId: 0,
                newAuthenticatorPubkey: U256::from(300),
                oldAuthenticatorAddress: Address::ZERO,
                newAuthenticatorAddress: Address::ZERO,
                oldOffchainSignerCommitment: U256::ZERO,
                newOffchainSignerCommitment: U256::from(300),
            }),
        },
    )
    .await
    ...
    insert_test_world_tree_event(
        ...
        &BlockchainEvent {
            ...
            details: RegistryEvent::AccountUpdated(AccountUpdatedEvent {
                leafIndex: 2,
                pubkeyId: 0,
                newAuthenticatorPubkey: U256::from(400),
                oldAuthenticatorAddress: Address::ZERO,
                newAuthenticatorAddress: Address::ZERO,
                oldOffchainSignerCommitment: U256::ZERO,
                newOffchainSignerCommitment: U256::from(400),
            }),
        },
    )
    .await
    ...
    insert_test_world_tree_event(
        ...
        &BlockchainEvent {
            ...
            details: RegistryEvent::AccountCreated(AccountCreatedEvent {
                ...
                authenticatorAddresses: vec![],
                authenticatorPubkeys: vec![],
                offchainSignerCommitment: U256::from(500),
            }),
        },
    )
    .await
