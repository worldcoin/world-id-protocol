...
async fn e2e_gateway_full_flow() {
    ...
    let body_ins = InsertAuthenticatorRequest {
        ...
        signature: sig_ins.as_bytes().to_vec().into(),
        nonce,
        pubkey_id: 1,
    ...
    let body_rem = RemoveAuthenticatorRequest {
        ...
        signature: sig_rem.as_bytes().to_vec().into(),
        nonce,
        pubkey_id: Some(1),
    ...
    let body_rec = RecoverAccountRequest {
        ...
        signature: sig_rec.as_bytes().to_vec().into(),
        nonce,
    ...
    let body_upd = UpdateAuthenticatorRequest {
        ...
        signature: sig_upd.as_bytes().to_vec().into(),
        nonce,
        pubkey_id: 0,
