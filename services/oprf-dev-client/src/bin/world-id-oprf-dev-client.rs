...
use uuid::Uuid;
use world_id_core::{
    proof::CircomGroth16Material, Authenticator, AuthenticatorError, Credential, EdDSAPrivateKey,
    EdDSAPublicKey, FieldElement, HashableCredential,
};
...
pub struct OprfDevClientConfig {
    ...
    #[clap(
        ...
        default_value = "0x016D886580503ac1d9429aB44eECAB303B2b94a6"
    )]
