...
- The `WorldIdVerifier` depends on:
    1. Access to the latest Merkle root
    2. Synchronized Credential issuer Pub Keys from the `CredentialIssuerSchemaRegistry`
    3. Synchronized Oprf Pub Keys from the `OprfKeyRegistry`
