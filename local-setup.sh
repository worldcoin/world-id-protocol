...
start_node() {
    ...
    TACEO_OPRF_NODE_BIND_ADDR=127.0.0.1:$port \
    TACEO_OPRF_NODE_SERVICE_WORLD_ID_REGISTRY_CONTRACT=$world_id_registry \
    TACEO_OPRF_NODE_SERVICE_RP_REGISTRY_CONTRACT=$rp_registry \
    TACEO_OPRF_NODE_SERVICE_CREDENTIAL_SCHEMA_ISSUER_REGISTRY_CONTRACT=$credential_schema_issuer_registry \
    TACEO_OPRF_NODE_SERVICE_BILLING_CONTRACT=$billing_contract \
    ...
    TACEO_OPRF_NODE_SERVICE_RPC_HTTP_URLS=http://127.0.0.1:8545 \
    TACEO_OPRF_NODE_SERVICE_RPC_CHAIN_ID=31337 \
