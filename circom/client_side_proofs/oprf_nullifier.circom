...
include "crl/crl_non_membership_smt_full.circom";
...
template OprfNullifier(MAX_DEPTH, CRL_KEY_BITS) {
    ...
    signal input crl_siblings[CRL_KEY_BITS];
    // Oprf query
    signal input beta;
    ...
    component crl_checker = CrlNonMembershipSmtFull(CRL_KEY_BITS);
...
// component main {public [issuer_schema_id, cred_pk, current_timestamp, cred_genesis_issued_at_min, merkle_root, depth, crl_root, rp_id, action, oprf_pk, signal_hash, nonce, id_commitment]} = OprfNullifier(30, 64);
